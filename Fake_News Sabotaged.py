...
catID = CategoricalDtype(categories = ["fake","real"], ordered = False)
...
real_text = " ".join(fake_news[fake_news['label'] == 1]['title'].values)
...
vectors = vectorizer.fit_transform(fake_news.label)
